		...
		<table class="table table-striped table-bordered border-1">
			<thead>
				<tr>
					...
					<th class="min-width-100 middle">Members</th>
				</tr>
			</thead>
			<tbody>
				<?php if(!empty($data)) : ?>
				...
				<?php foreach($data as $rs) : ?>
					<tr>
						...
						<td class="middle"><?php echo $rs->member; ?></td>
					</tr>
					<?php $no++; ?>
				<?php endforeach; ?>
			<?php endif; ?>
...
<script src="<?php echo base_url(); ?>scripts/users/user_group.js?v=<?php echo date('Ymd'); ?>"></script>
